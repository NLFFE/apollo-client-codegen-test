...
export type GetCompanyQuery = { __typename?: 'Query', company?: { __typename?: 'Info', ceo?: string | null } | null };
...
export type GetHistoriesQuery = { __typename?: 'Query', histories?: Array<{ __typename?: 'History', id?: string | null } | null> | null };
...
export const GetHistoriesDocument = gql`
    query getHistories($find: HistoryFind) {
  histories(find: $find) {
    id
  }
}
 ...
 *
 * To run a query within a React component, call `useGetHistoriesQuery` and pass it any options that fit your needs.
 * When your component renders, `useGetHistoriesQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useGetHistoriesQuery({
 *   variables: {
 *      find: // value for 'find'
 *   },
 * });
 */
export function useGetHistoriesQuery(baseOptions?: Apollo.QueryHookOptions<GetHistoriesQuery, GetHistoriesQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<GetHistoriesQuery, GetHistoriesQueryVariables>(GetHistoriesDocument, options);
      }
export function useGetHistoriesLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<GetHistoriesQuery, GetHistoriesQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<GetHistoriesQuery, GetHistoriesQueryVariables>(GetHistoriesDocument, options);
        }
export type GetHistoriesQueryHookResult = ReturnType<typeof useGetHistoriesQuery>;
export type GetHistoriesLazyQueryHookResult = ReturnType<typeof useGetHistoriesLazyQuery>;
export type GetHistoriesQueryResult = Apollo.QueryResult<GetHistoriesQuery, GetHistoriesQueryVariables>;